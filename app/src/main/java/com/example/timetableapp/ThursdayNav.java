...
public class ThursdayNav extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void addCardView()
    {
        ...
        //
        // timetable = front.getArr();
        //
        LinearLayout l = findViewById(R.id.thur);
        ...
        for(int r = 1 ; r <=6 ;r++) {
            ...
            tempR1.setText(timeTableArr[r][0]+"\t\t\t\t\t\t\t\t\t\t\t"+timeTableArr[r][4]);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id)
        {
            ...
            case R.id.nav_appointment:
                Intent app = new Intent(ThursdayNav.this,Appointment.class);
